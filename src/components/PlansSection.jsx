...
const plans = [
  {
    icon: (
      <svg width="38" height="38" fill="none" viewBox="0 0 38 38"><circle cx="19" cy="19" r="19" fill="#e8f0ff"/><path d="M19 12l2.5 5h-5L19 12zm0 14c-3.9 0-7-3.1-7-7 0-1.1.2-2.1.6-3h12.8c.4.9.6 1.9.6 3 0 3.9-3.1 7-7 7z" fill="#0057FF"/></svg>
    ),
    name: 'Explorador',
    price: 'Gratis',
  ...
  {
    icon: (
      <svg width="38" height="38" fill="none" viewBox="0 0 38 38"><circle cx="19" cy="19" r="19" fill="#f3f6fd"/><path d="M19 12a7 7 0 100 14 7 7 0 000-14zm0 12a5 5 0 110-10 5 5 0 010 10z" fill="#0057FF"/></svg>
    ),
    name: 'Cuidador',
    price: '$99',
  ...
  {
    icon: (
      <svg width="38" height="38" fill="none" viewBox="0 0 38 38"><circle cx="19" cy="19" r="19" fill="#e8f0ff"/><rect x="12" y="14" width="14" height="10" rx="2" fill="#0057FF"/></svg>
    ),
    name: 'Empresas',
    price: 'Desde $99',
      ...
      <div style={{ display: 'flex', gap: '2.5rem', justifyContent: 'center', alignItems: 'stretch', marginTop: 40, flexWrap: 'nowrap' }}>
        {plans.map((plan, i) => (
          ...
          >
            ...
            <button style={{ background: '#0057FF', color: '#fff', border: 'none', borderRadius: 12, padding: '1rem 2.2rem', fontWeight: 700, fontSize: 18, cursor: 'pointer', boxShadow: '0 2px 8px #0057ff22', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 10 }}>
              {plan.button}
            </button>
          </div>
        ))}
