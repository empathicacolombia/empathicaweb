    ...
    <section style={{ background: '#fcfcfd', padding: '5rem 0 4rem 0' }}>
      <div style={{ maxWidth: 1300, margin: '0 auto', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 24 }}>
          ...
          {/* Tarjetas */}
          {visible.map((psy, i) => (
            <div key={i} style={{ background: '#fff', borderRadius: 20, border: '1.5px solid #e3e6f0', boxShadow: '0 4px 32px #0001', padding: '2.2rem 2rem 2rem 2rem', minWidth: 370, maxWidth: 420, display: 'flex', flexDirection: 'column', alignItems: 'flex-start', position: 'relative', transition: 'transform 0.25s cubic-bezier(.4,2,.6,1)', cursor: 'pointer' }}>
              {/* Match */}
              ...
              <button style={{ background: '#0057FF', color: '#fff', border: 'none', borderRadius: 12, padding: '1rem 2.2rem', fontWeight: 700, fontSize: 17, cursor: 'pointer', boxShadow: '0 2px 8px #0057ff22', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 10 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: 48 }}>
          <div style={{ background: '#fff', borderRadius: 24, border: '1.5px solid #e3e6f0', boxShadow: '0 4px 32px #0001', padding: '2.5rem 2rem 2.5rem 2rem', maxWidth: 600, width: '100%', textAlign: 'center' }}>
            <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 18 }}>
              <svg width="38" height="38" fill="none" viewBox="0 0 38 38"><circle cx="19" cy="19" r="19" fill="#e8f0ff"/><path d="M19 11c-2.2 0-4 1.8-4 4v2c0 2.2 1.8 4 4 4s4-1.8 4-4v-2c0-2.2-1.8-4-4-4Zm0 9c-1.7 0-3-1.3-3-3v-2c0-1.7 1.3-3 3-3s3 1.3 3 3v2c0 1.7-1.3 3-3 3Z" fill="#0057FF"/></svg>
            </div>
            ...
            <button style={{ background: '#0057FF', color: '#fff', border: 'none', borderRadius: 12, padding: '1rem 2.2rem', fontWeight: 700, fontSize: 17, cursor: 'pointer', boxShadow: '0 2px 8px #0057ff22', display: 'flex', alignItems: 'center', gap: 8, margin: '0 auto' }}>
